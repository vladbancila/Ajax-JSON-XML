...
import domain.Composer;
import domain.ComposerData;
...
public class AutoCompleteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    //System.out.println(targetId + action);
	    StringBuffer sb = new StringBuffer();

	    if (targetId != null) {
	        targetId = targetId.trim().toLowerCase();
	    } else {
	        context.getRequestDispatcher("/WEB-INF/error.jsp").forward(request, response);
	    }
	    ...
	    if (action.equals("lookup")) {
	        ...
	        if ((targetId != null) && composers.containsKey(targetId.trim())) {
	            ...
	            context.getRequestDispatcher("/WEB-INF/composer.jsp").forward(request, response);
	        }
	    }
	}
