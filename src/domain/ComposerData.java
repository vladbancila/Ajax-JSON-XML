...
public class ComposerData {
    ...
    public ComposerData() {
        ...
        composers.put("51", new Composer("51", "Vlad", "Bancila", "Modern"));
        composers.put("52", new Composer("52", "Gabriel", "Ochiana", "Old Music"));
        composers.put("53", new Composer("53", "George", "Sand", "Genius"));
        composers.put("52", new Composer("52", "Daniel", "Mogosan", "Tester"));
    }
}